...
# Updated 11/14/18 by DJ - added escape key to ShowVAS that quits out of experiment
    ...
    for iQ in range(nQuestions):
        ...
        while (time.time()-tStart)<questionDur:
            ...
            if keyState[getattr(key,downKey_attr)]: #returns True if left key is pressed
                ...
                step = stepSize
            elif keyState[getattr(key,'ESCAPE')]: # if escape key is pressed, exit experiment
