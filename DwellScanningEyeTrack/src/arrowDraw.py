...
# some shapes:
r = 1000
arrowLeft = [(-0.2*r,0.05*r),(-0.2*r,-0.05*r),(0,-0.05*r),(0,-0.1*r),(0.2*r,0),(0,0.1*r),(0,0.05*r)]
arrowRight = [(0.2*r,0.05*r),(0.2*r,-0.05*r),(0,-0.05*r),(0,-0.1*r),(-0.2*r,0),(0,0.1*r),(0,0.05*r)]
arrowLine = [(-0.2*r,0.05*r),(-0.2*r,-0.05*r),(.2*r,-.05*r),(.2*r,0.05*r)]

arrowR = ShapeStim(win, vertices=arrowRight, units='pix',fillColor='black', size=.5, lineColor='black',pos=[0,.1*r])
arrowL = ShapeStim(win, vertices=arrowLeft, units='pix',fillColor='black', size=.5, lineColor='black',pos=[-0.3*r,.1*r])
arrowLine = ShapeStim(win, vertices=arrowLine, units='pix',fillColor='black', size=.5, lineColor='black',pos=[0.3*r,.1*r])
